...
async function main (skill) {
    //launches chromium                    headless : we want to see browser opening and closing
    ...
    const jobData = await page.evaluate(async (data) => {
        ...
        let json = await JSON.stringify(jobData,null,2) //(value: any, replacer?: (string | number)[] | null | undefined, space?: string | number | undefined): string (+1 overload)
